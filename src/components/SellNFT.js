...
export default function SellNFT () {
    ...
    async function listNFT(e) {
        ...
        try {
            ...
            // Skip contract check - just try to call it
            ...
            disableButton();
            updateMessage("Minting NFT... please wait!");
            ...
            try {
                ...
                listingPrice = "10000000000000000"; // 0.01 ETH in wei
            }
